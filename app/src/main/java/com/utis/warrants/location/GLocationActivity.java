...
public class GLocationActivity extends FragmentActivity implements
		LocationListener,
    ...
    private TextView mLatLng, mAddress;
    private ProgressBar mActivityIndicator;
    private TextView mConnectionState, mConnectionStatus;
    ...
    public void getAddress(View v) {
        ...
        if (servicesConnected()) {
            ...
            (new GLocationActivity.GetAddressTask(this)).execute(currentLocation);
        }
    }
